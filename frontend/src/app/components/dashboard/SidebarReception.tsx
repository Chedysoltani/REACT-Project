...
import { CalendarDays, UserPlus, CreditCard, LayoutDashboard, LogOut } from "lucide-react"

const SidebarReception = () => {
  const pathname = usePathname()

  const menu = [
    { name: "Dashboard", icon: <LayoutDashboard size={20} />, path: "/reception" },
    { name: "Rendez-vous", icon: <CalendarDays size={20} />, path: "/reception/rendezvous" },
    { name: "Patients", icon: <UserPlus size={20} />, path: "/reception/patients" },
    { name: "Facturation", icon: <CreditCard size={20} />, path: "/reception/facturation" },
  ]
